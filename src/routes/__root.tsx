...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Leonardo LF | Criação de Sites Profissionais" },
      { name: "description", content: "Sites profissionais para construtoras e construtores que querem crescer na internet. Criação de landing pages, sites institucionais e redesign." },
      { name: "author", content: "Leonardo LF" },
      { property: "og:title", content: "Leonardo LF | Criação de Sites Profissionais" },
      { property: "og:description", content: "Sites profissionais para construtoras e construtores que querem crescer na internet. Criação de landing pages, sites institucionais e redesign." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:site", content: "@leonardolf" },
      { name: "twitter:title", content: "Leonardo LF | Criação de Sites Profissionais" },
      { name: "twitter:description", content: "Sites profissionais para construtoras e construtores que querem crescer na internet. Criação de landing pages, sites institucionais e redesign." },
